...
$_IMC = array();
$_IMC["version"] = "3.0.0pre";//版本
$_IMC["enable"] = true;//开启webim
$_IMC["domain"] = "monit.cn";//网站注册域名
$_IMC["apikey"] = "public";//网站注册apikey
$_IMC["imsvr"] = "localhost";//im服务器
$_IMC["impost"] = 8000;//服务端接口端口
$_IMC["impoll"] = 8000;//客户端接口端口
